...
#ALJS_V2
#cl = LineClient()
cl = LineClient(authToken='ExZlcRUzaCGS3Fp0k5be.vhFFhKOTsNM6QJ89dDc+xG.YgGgg0KNJ5Id2WRgGiX+6UKE2bKzwmJWtG57p1KbFkg=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='ExjRnUDiNt179YaCkG16.2+xbdGMfVUVmaEYntevmbG.5W/ldsHVNqZFdHKaUrho1Y7ye+TUFXNnsMEVHZ2KXJ4=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='ExXRdo01HZr5jAXwQ7j9./bNBiRyDzlJbmoF6Rpvzoq.HBvAjfUyKwU3qlI33LTBnuGxl2NNpNlxcOdFEDXgU4g=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='ExVWGb2z9mPark1KjOcb.lqP5h9mPsVRdrezzmZkNsW.PHUP5g8amVNTlB2KeXtfLWSdkRhSjJ6eVDzR2EZKD/0=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='Ex1DBQ24O5LKLkQ2C7U8.zu4YYlvD36uCvnZ/0THnsa.RNAMHCw3+NU00a9GgOI3xUsx1ElGb3kRhMzbXDzDGLQ=')
...
wait = {
    ...
    "Respontag":"BY: ™A҉l҉f҉i҉a҉n҉ B҉i҉s҉m™",
    "welcome":"Selamat datang & betah",
    "comment":"Like like & like by ™A҉l҉f҉i҉a҉n҉ B҉i҉s҉m™",
